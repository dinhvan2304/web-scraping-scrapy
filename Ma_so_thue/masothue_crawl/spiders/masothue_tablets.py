...
from masothue_crawl.items import MasothueCrawlItem

TYPE_UPDATE = 0
TYPE_INSERT = 1

class MasothueTabletsSpider(scrapy.Spider):
    name = 'masothue_tablets'
    ...
    custom_settings={
        ...
        # 'FEED_FORMAT': 'csv',
        "ITEM_PIPELINES": {
            "masothue_crawl.pipelines.MasothueCrawlPipeline": 500,
        },
        "ITEM_CLASS": "masothue_crawl.items.MasothueCrawlItem",
    }
