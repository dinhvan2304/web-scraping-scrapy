...
from masothue_pipeline.items import MasothuePipelineItem
...
class MasothueSpider(scrapy.Spider):
    ...
    start_url = 'https://masothue.com/'

    custom_settings={
        # 'FEED_URI': "masothue_%(time)s.csv",
        # 'FEED_FORMAT': 'csv',
        "ITEM_PIPELINES": {
            "masothue_pipeline.pipelines.MasothuePipelinePipeline": 500,
        },
        "ITEM_CLASS": "masothue_pipeline.items.MasothuePipelineItem",
    }
    
    def start_requests(self):
        mst_urls = pd.read_csv('/Users/dinhvan/Document/Projects/crawl_data/scrapy/masothue_pipeline/masothue_pipeline/masothue_url.csv', dtype = object)
